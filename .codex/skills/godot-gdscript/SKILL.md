...
GDScript 2.0 code quality, patterns, and optimization for Godot 4.7 projects.

For this scaffold, verify version-sensitive behavior against Context7 library
