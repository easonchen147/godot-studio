...
Native code integration for Godot 4.7 via GDExtension: C++ (godot-cpp), Rust
(godot-rust), custom nodes, performance optimization, and cross-platform builds.

For this scaffold, verify version-sensitive ABI and binding behavior against
Context7 library `/websites/godotengine_en_4_7`.
